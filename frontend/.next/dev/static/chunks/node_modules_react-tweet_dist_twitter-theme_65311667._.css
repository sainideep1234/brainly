...
/* [project]/node_modules/react-tweet/dist/twitter-theme/highlighted-label.module.css [app-client] (css) */
.highlighted-label-module__P9Fova__label {
  border: var(--tweet-border);
  border-radius: 2px;
  width: 1.0625em;
  max-width: 17px;
...
.highlighted-label-module__P9Fova__label > img {
  width: 100%;
  height: 100%;
}
...
.quoted-tweet-header-module__Cx2l9W__avatarOverflow {
  border-radius: 9999px;
  width: 100%;
  height: 100%;
  position: absolute;
...
/*# sourceMappingURL=node_modules_react-tweet_dist_twitter-theme_65311667._.css.map*/