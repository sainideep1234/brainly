...
const ShareModal = ({ onShareClick })=>{
    _s();
    const [shareHash, setShareHash] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShareModal.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$httpclients$2f$httpclient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareBrain"])(true).then({
                "ShareModal.useEffect": (res)=>{
            ...
            }["ShareModal.useEffect"]).catch({
                "ShareModal.useEffect": (err)=>{
                    setError("Failed to load share settings");
                }
            }["ShareModal.useEffect"]).finally({
                "ShareModal.useEffect": ()=>{
                    setLoading(false);
                }
            }["ShareModal.useEffect"]);
    ...
    const handleDisable = async ()=>{
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$httpclients$2f$httpclient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareBrain"])(false);
            if (res.success) {
                setShareHash("");
...
_s(ShareModal, "yMpZX7O1qrJ3WiMU+HLJfYIO/gU=");
_c = ShareModal;
...
//# sourceMappingURL=_d40f7405._.js.map